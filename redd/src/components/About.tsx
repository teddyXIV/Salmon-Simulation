const About = (props: ModalControl) => {

    return (
        <>
            <div>
                <dialog open onClick={props.closeHandler} className="fixed top-0 left-0 h-screen w-screen bg-black bg-opacity-75 z-50">
                    <div className="border-none bg-black bg-opacity-75 w-full h-1/2 sm:w-5/6 sm:h-1/4 rounded-lg shadow-md p-0 overflow-hidden z-50 m-auto mt-32">
                        <p className="text-white text-center p-10 sm:p-20 sm:text-xl">
                            ...
                            <br />
                            Submit a date to view a simulated dispersal of salmon for the specified date.
                        </p>
                    </div>
                </dialog>
            </div>
